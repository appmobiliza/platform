...
import { ArrowLeft, Utensils, Book, Building, Star, MoreVertical, Plus } from "lucide-react-native";
...
export default function SavedPlaces() {
  ...
  const savedPlaces = [
    ...
    { id: 4, name: "Banquinho da Meteorologia", subtitle: "Instituto de Jornalismo, UFAL", icon: Star, showMenu: true },
  ];
  ...
  return (
    <View className="flex-1 bg-white">
      ...
      >
        ...
        <Text className="text-gray-900 font-bold text-3xl">Locais salvos</Text>
      </View>
      ...
      <ScrollView className="flex-1 px-6">
          ...
          return (
            ...
            >
              ...
              <View className="flex-1 ml-4">
                <Text className="text-gray-900 font-semibold text-base">{place.name}</Text>
                {place.subtitle && (
                  <Text className="text-gray-500 text-xs mt-0.5">{place.subtitle}</Text>
                )}
              </View>
              {place.showMenu && (
                <TouchableOpacity 
        ...
        >
          ...
          <Text className="text-gray-900 font-medium text-base">Adicionar um novo local</Text>
        </TouchableOpacity>
      </ScrollView>
      ...
      <Modal visible={showOptionsModal} transparent animationType="fade">
        ...
        >
          <View className="bg-white rounded-xl w-48 shadow-lg py-2 absolute right-6" style={{ top: '40%' }}>
            <TouchableOpacity onPress={handleEdit} className="px-5 py-3">
              <Text className="text-gray-800 text-base">Editar</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={handleDeleteClick} className="px-5 py-3">
              <Text className="text-gray-800 text-base">Excluir</Text>
            </TouchableOpacity>
          </View>
        </Pressable>
      </Modal>
        ...
        >
          <Pressable className="bg-white rounded-[24px] w-full pt-8 pb-6 px-6">
            ...
            <Text className="text-gray-500 text-center mb-8 px-4">
              Deseja excluir {selectedPlace?.name || 'Local'} dos locais salvos?
            </Text>
            <View className="gap-3">
              ...
              >
                <Text className="text-gray-600 font-semibold text-base">Cancelar</Text>
              </TouchableOpacity>
            </View>
          </Pressable>
        </Pressable>
