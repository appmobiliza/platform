...
// TODO: Refatorar pra usar componentes do Radix e remover dependência do @base-ui/react
...
function ComboboxChip({
	...
	return (
		<ComboboxPrimitive.Chip
			...
			className={cn(
				"flex h-[calc(--spacing(6.5))] w-fit items-center justify-center gap-1 rounded-sm bg-muted px-1.5 text-xs font-medium whitespace-nowrap text-foreground has-disabled:pointer-events-none has-disabled:cursor-not-allowed has-disabled:opacity-50 has-data-[slot=combobox-chip-remove]:pr-0",
				className,
			)}
			{...props}
		>
