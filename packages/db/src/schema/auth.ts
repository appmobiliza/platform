 ...
 * Não modifique manualmente — adicione campos extras via plugins do Better Auth
 * ou referencie a tabela `user` nas tabelas de domínio do Mobiliza.
 *
 * Referência: https://www.better-auth.com/docs/concepts/database
 */
...
export const user = pgTable("user", {
  ...
  /*
   * Campo extra adicionado ao schema do Better Auth para que a aplicação
